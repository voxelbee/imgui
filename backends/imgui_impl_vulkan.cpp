...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
    ...
    VkDescriptorSet font_descriptor_set = (VkDescriptorSet)ImGui_ImplVulkan_CreateTexture();
    ImGui_ImplVulkan_UpdateTexture(g_FontSampler, g_FontView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, (ImTextureID)font_descriptor_set);
...
void ImGui_ImplVulkan_UpdateTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout, ImTextureID texture)
{
    ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
    // Update the Descriptor Set:
    {
        ...
        write_desc[0].dstSet = (VkDescriptorSet)texture;
